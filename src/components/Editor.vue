            ...
            {   //鼠标指上去：文本提示
                ...
                onAction() {
                    ...
                    ChooseImageRef.value.open((data) => {
                        //data由地址组成的数组
                        data.forEach(url => {
                            //获取ChooseImage.vue组件传过来的图片地址并渲染出来
                            editor.insertContent(`<img src='${url}' style='width:100%;'/>`)
                        })
                    })
                    // editor.insertContent(`<img src="http://tangzhe123-com.oss-cn-shenzhen.aliyuncs.com/public/60029fca47cda.jpg" style="width:100%;"/>`)
                }
            }
        )
    }
